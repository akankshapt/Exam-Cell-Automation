...
<head>
		...
		<!-- Title -->
		<title> Disapproved User View</title>
					...
					<div>
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page"> Disapproved User</li>
							</ol>
						</nav>
					</div>
								...
								<div class="table-responsive">
									<table id="example" class="table key-buttons text-md-nowrap">
										...
										<tbody>
											<?php 
			                                    $count=0; 
			                                    $query="select u.*,g.* from tbl_user u, tbl_standard g where u.fld_user_status='Disapproved' and g.fld_standard_id=u.fld_standard_id order by u.fld_user_id desc";
											...
											<tr>
												...
												<td>
													<a href="user_delete.php?fld_user_id=<?php echo $fetch['fld_user_id'] ?>&page=disapp" onclick="return confirm('You are sure to delete the Disapproved User.')" title="Delete Disapproved User" ><i class="fa fa-trash text-danger" style="font-size: 20px; " ></i></a>

													<a href="user_approve.php?fld_user_id=<?php echo $fetch['fld_user_id'] ?>&page=disapp" title="Approve User" ><i class="fa fa-thumbs-up text-success" style="font-size: 20px; padding-left: 10px" ></i></a>
												</td>
