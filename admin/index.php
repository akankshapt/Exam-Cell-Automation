...
<head>
			...
			<div class="main-signin-wrapper">
				...
				<div class="wd-md-50p login d-none d-md-block page-signin-style p-5 text-white" >
					<div class="my-auto authentication-pages">
						<div>
							<img src="assets/img/brand/admin logo-white.png" class=" m-0 mb-4" alt="logo">
    ...
    if(isset($_POST['login']))
    {
        ...
        $log=mysqli_query($connect,"select * from tbl_admin where fld_admin_email='$email' and fld_admin_password='$password'") or die (mysqli_error($connect));
