...
<head>
		...
		<!-- Title -->
		<title> Registered User View</title>
								...
								<div class="table-responsive">
									<table id="example" class="table key-buttons text-md-nowrap">
										...
										<tbody>
											<?php 
			                                    $count=0; 
			                                    $query="select u.*,g.* from tbl_user u, tbl_standard g where u.fld_user_status='Registered' and g.fld_standard_id=u.fld_standard_id order by u.fld_user_id desc";
											...
											<tr>
												...
												<td>
													<a href="user_delete.php?fld_user_id=<?php echo $fetch['fld_user_id'] ?>&page=reg" onclick="return confirm('You are sure to delete the Registered User.')" title="Delete Registered User" ><i class="fa fa-trash text-danger" style="font-size: 20px; " ></i></a>

													<a href="user_approve.php?fld_user_id=<?php echo $fetch['fld_user_id'] ?>&page=reg" title="Approve User" ><i class="fa fa-thumbs-up text-success" style="font-size: 20px; padding-left: 10px" ></i></a>

													<a href="user_disapprove.php?fld_user_id=<?php echo $fetch['fld_user_id'] ?>&page=reg" title="Disapprove User" ><i class="fa fa-thumbs-down text-danger" style="font-size: 20px; padding-left: 10px" ></i></a>
												</td>
