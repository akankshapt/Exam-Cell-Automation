								...
								<div class="table-responsive">
									<table id="example" class="table key-buttons text-md-nowrap">
										...
										<tbody>
											<?php 
			                                    $count=0; 
			                                    $query="select r.*,sub.*,std.* from tbl_result r, tbl_subject sub,  tbl_standard std where std.fld_standard_id=sub.fld_standard_id and std.fld_standard_id=r.fld_standard_id and sub.fld_standard_id=r.fld_standard_id and sub.fld_subject_id=r.fld_subject_id and r.fld_standard_id='".$fetch_user['fld_standard_id']."' and r.fld_user_id='".$_SESSION['fld_user_id']."'  group by r.fld_result_id order by r.fld_result_id desc";
