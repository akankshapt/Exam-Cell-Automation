				...
				<div class="col-lg-12 col-md-12">
					<div class="card">
						<div class="card-body">
								...
								<?php 
                                    $count=0; 
                                    $query="select r.*,sub.*,u.*,std.* from tbl_result r, tbl_subject sub, tbl_user u, tbl_standard std where std.fld_standard_id=sub.fld_standard_id and std.fld_standard_id=r.fld_standard_id and  std.fld_standard_id=u.fld_standard_id and sub.fld_standard_id=r.fld_standard_id and  sub.fld_standard_id=u.fld_standard_id and r.fld_standard_id=u.fld_standard_id and sub.fld_subject_id=r.fld_subject_id and   r.fld_user_id=u.fld_user_id and r.fld_standard_id='".$fetch_user['fld_standard_id']."' and r.fld_user_id='".$_SESSION['fld_user_id']."' group by r.fld_result_id order by r.fld_result_id desc";
