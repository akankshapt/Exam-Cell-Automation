					...
					<div class="col-xl-12">
						<div class="card mg-b-20">
							...
							<div class="card-body">
								...
								<?php 
									$query="select r.*,sub.*,std.* from tbl_result r, tbl_subject sub,  tbl_standard std where std.fld_standard_id=sub.fld_standard_id and std.fld_standard_id=r.fld_standard_id and sub.fld_standard_id=r.fld_standard_id and sub.fld_subject_id=r.fld_subject_id and r.fld_standard_id='".$fetch_user['fld_standard_id']."' and r.fld_user_id='".$_SESSION['fld_user_id']."' and r.fld_result_id='".$_GET['fld_result_id']."'  group by r.fld_result_id order by r.fld_result_id desc";
