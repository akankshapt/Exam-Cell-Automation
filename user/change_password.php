...
<?php
	if(isset($_POST['change']))
	{
		...
		$query='select * from tbl_user where fld_user_email="'.$_SESSION['email'].'" and fld_user_password="'.$_POST['old_password'].'"';
		...
		if(mysqli_num_rows($res)>0)
		{
			if(strlen($_POST['new_password'])>=3)
			{
				...
				{
					$query1='update tbl_user set fld_user_password="'.$_POST['new_password'].'"
