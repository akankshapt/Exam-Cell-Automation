...
$query_user=mysqli_query($connect,"select u.*,s.* from tbl_user u, tbl_standard s where u.fld_user_email='".$_SESSION['email']."' and u.fld_standard_id=s.fld_standard_id group by u.fld_user_id") or die(mysqli_error($connect));
...
<!-- Switcher -->
		...
		<aside class="main-sidebar app-sidebar sidebar-scroll">
			<div class="main-sidebar-header">
				<a class="desktop-logo logo-light active" href="dashboard.php" class="text-center mx-auto"><img src="assets/img/brand/user logo.png" class="main-logo"></a>
				<a class="desktop-logo icon-logo active" href="dashboard.php"><img src="assets/img/brand/favicon.png" class="logo-icon"></a>
				<a class="desktop-logo logo-dark active" href="dashboard.php"><img src="assets/img/brand/User logo-white.png" class="main-logo dark-theme" alt="logo"></a>
			...
			<div class="main-sidebar-loggedin">
				<div class="app-sidebar__user">
					<div class="dropdown user-pro-body text-center">
						<div class="user-pic">
							<?php if ($fetch_user['fld_user_photo']=="") 
		                            {
		                        ?>
		                        ...
		                        <?php
		                            ...
		                            {
		                        ?>                                        
		                                <img src="../images/user/<?php echo $fetch_user['fld_user_photo'];?>" alt="No Image"  class="rounded-circle mCS_img_loaded" />
		                        <?php
		                            }
		                        ?>
						...
						<div class="user-info">
							<h6 class=" mb-0 text-dark"><?php echo $fetch_user['fld_user_name']; ?></h6>
			...
			<div class="main-sidebar-body">
				<ul class="side-menu ">
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon fa fa-question menu-icons"></i><span class="side-menu__label">Test Question</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<?php
								$query_subject=mysqli_query($connect,"select * from tbl_subject where fld_standard_id='".$fetch_user['fld_standard_id']."' order by fld_subject_name asc");
			                      while($row_subject=mysqli_fetch_assoc($query_subject)){
			                        extract($row_subject);
			                ?>
							<li><a class="slide-item" href="start_test.php?fld_subject_id=<?php echo $row_subject['fld_subject_id'];?>"><?php echo $row_subject['fld_subject_name'];?></a></li>
							<?php } ?>
						</ul>
					</li>
				...
				<div class="container-fluid">
					<div class="main-header-left ">
						...
						<div class="responsive-logo">
							<a href="dashboard.php"><img src="assets/img/brand/User logo-white.png" class="logo-1"></a>
							<a href="dashboard.php"><img src="assets/img/brand/user logo.png" class="logo-11"></a>
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
		                        ...
		                        <?php
		                            ...
		                            {
		                        ?>                                        
		                                <img src="../images/user/<?php echo $fetch_user['fld_user_photo'];?>" alt="No Image"  />
		                        <?php
		                            }
		                        ?>
										</div>
										<h6><?php echo $fetch_user['fld_user_name']; ?></h6>
										<span><?php echo $fetch_user['fld_user_email']; ?></span>
									</div>
